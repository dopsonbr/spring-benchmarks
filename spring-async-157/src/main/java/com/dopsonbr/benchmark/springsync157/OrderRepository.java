...
public class OrderRepository {
    ...
    public CompletableFuture<String> getTaxInfo() {
        ...
        return CompletableFuture.completedFuture(tax);
    }

    public CompletableFuture<String> getItemInfo() {
        logger.info("getting tax");
        ...
        return CompletableFuture.completedFuture(itemInfo);
    }
